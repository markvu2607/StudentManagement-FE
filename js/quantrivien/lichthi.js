...
const openUpdateLichThi = async (idLop) => {
  ...
  document.querySelector("#formUpdate #thoiGianThi").value = lichthi.thoiGian
    ? moment(lichthi.thoiGian).format("YYYY-MM-DDTkk:mm")
    : "";
...
const openViewLichThi = async (idLop) => {
  ...
  document.querySelector("#formView #thoiGianThi").value = lichthi.thoiGian
    ? moment(lichthi.thoiGian).format("YYYY-MM-DDTkk:mm")
    : "";
  document.querySelector("#formView #phongThi").value = lichthi.phongThi
    ? lichthi.phongThi
    : "";
};
